...
// The Scale tab has two views: the octave play-along and the per-note explorer.
export type ScaleMode = 'scale' | 'notes'

/** A jump into a tool tab, optionally preconfigured — fired by a Guide stage. */
export type Preset = { tab: Tab; exerciseId?: string; scaleMode?: ScaleMode }
