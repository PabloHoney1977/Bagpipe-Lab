...
- **Next concrete step:** source real recorded chanter samples (check `nbrosowsky/tonejs-instruments` first) to replace the synthesized placeholder tone; then move to phase 2 ("The scale").
